...
{ 
        ...
        public String executeCommand(String command){
            ...
            try{
                ...
                //else if condition for rmdir command
                    ...
                    dos.writeUTF("rmdir "+currDir+"\\"+res[1]+" "+this.clientName);
                    output = dis.readUTF();
                }
        ...
        //Lab 3 get ArrayList for logged operations
//        public ArrayList getLoggedOperations(){
//            ArrayList al = new ArrayList();
//            try {
//                dos.writeUTF("getLoggedOperations");
//                al = (ArrayList) ois.readObject();
//                System.out.println("client.java getLoggedOperations: "+al.toString());
//            } catch (Exception ex) {
//                ex.printStackTrace();
//            }
//            return al;
